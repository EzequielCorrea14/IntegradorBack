const productBodyValidator = (request, response, next) => {
    ...
    if(typeof color !== "string") validationArray.push('Color must be string')
    if(typeof image1 !== "string") validationArray.push('Image1 must be url.')
    if(typeof image2 !== "string") validationArray.push('Image2 must be url.')
    if(typeof image3 !== "string") validationArray.push('Image3 must be url.')
